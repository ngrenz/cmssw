...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/TrackerCommonData/data/PhaseII/trackerParameters.xml',
...
#        'Geometry/TrackerCommonData/data/PhaseII/BarrelEndcap5D/trackerpixfwd.xml',
